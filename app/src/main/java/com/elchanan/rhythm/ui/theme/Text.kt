...
/** Translates interface copy at the final display boundary, leaving music metadata untouched. */
@Composable
fun Text(
    text: String,
    ...
    MaterialText(
        text = UiStrings.translate(text, UiLanguage.code),
        modifier = modifier, color = color, fontSize = fontSize,
